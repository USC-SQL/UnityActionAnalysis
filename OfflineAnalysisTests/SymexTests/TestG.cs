...
namespace UnityActionAnalysis.Tests
{
    ...
    public class TestG
    {
        ...
        {
            using (SymexMachine machine = TestHelpers.CreateMachine("OfflineAnalysisTestCases.Symex.TestG.ProgramG", "Main", new ConfigG()))
            {
                machine.Run();
                ...
                using (var z3 = new Context(new Dictionary<string, string>() { { "model", "true" } }))
                {
                    ...
                    var rec3x = z3.MkConst("staticfield:OfflineAnalysisTestCases.Symex.TestG.GlobalState,OfflineAnalysisTestCases.thirdRecord:instancefield:position:instancefield:x", z3.MkFPSortSingle());
                    var rec3y = z3.MkConst("staticfield:OfflineAnalysisTestCases.Symex.TestG.GlobalState,OfflineAnalysisTestCases.thirdRecord:instancefield:position:instancefield:y", z3.MkFPSortSingle());
