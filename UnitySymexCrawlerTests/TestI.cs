...
namespace UnitySymexCrawler.Tests
{
    public class ConfigI : TestConfig
    {
        ...
        {
            return base.IsMethodSymbolic(method) || method.FullName == "TestCases.TestI.Record..ctor";
        }
    }
    ...
    public class TestI
    {
        ...
        {
            using (SymexMachine machine = TestHelpers.CreateMachine("TestCases.TestI.ProgramI", "Main", new ConfigI()))
            {
                machine.Run();
