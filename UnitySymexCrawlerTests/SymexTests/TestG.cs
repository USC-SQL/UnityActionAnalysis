...
namespace UnitySymexCrawler.Tests
{
    ...
    public class TestG
    {
        ...
        {
            using (SymexMachine machine = TestHelpers.CreateMachine("TestCases.Symex.TestG.ProgramG", "Main", new ConfigG()))
            {
                machine.Run();
                ...
                using (var z3 = new Context(new Dictionary<string, string>() { { "model", "true" } }))
                {
                    ...
                    var rec3x = z3.MkConst("staticfield:TestCases.Symex.TestG.GlobalState,TestCases.thirdRecord:instancefield:position:instancefield:x", z3.MkFPSortSingle());
                    var rec3y = z3.MkConst("staticfield:TestCases.Symex.TestG.GlobalState,TestCases.thirdRecord:instancefield:position:instancefield:y", z3.MkFPSortSingle());
